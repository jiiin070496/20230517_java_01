...
COMMENT ON COLUMN "BOARD_REPLY"."RNO" IS 'SEQ_BOARD_RNO 사용';
COMMENT ON COLUMN "BOARD_REPLY"."BRE" IS '타겟댓글번호';
COMMENT ON COLUMN "BOARD_REPLY"."BNO" IS 'SEQ_BOARD_BNO 사용';
COMMENT ON COLUMN "BOARD_REPLY"."RCONTENT" IS '내용';
COMMENT ON COLUMN "BOARD_REPLY"."RDATE" IS '작성시간';
COMMENT ON COLUMN "BOARD_REPLY"."BREL" IS '댓글 깊이';
COMMENT ON COLUMN "BOARD_REPLY"."BRES" IS '댓글순서';
=======
    "REP"       NUMBER    NOT NULL,
    "REPS"      NUMBER    NOT NULL,
    "REPL"      NUMBER    NOT NULL,
    "MID"       VARCHAR2(20) NOT NULL
);

COMMENT ON COLUMN "BOARD_REPLY"."RNO" IS ' 댓글번호, SEQ_BOARD_RNO 사용';
COMMENT ON COLUMN "BOARD_REPLY"."BNO" IS '원본글 번호, SEQ_BOARD_BNO 사용';
COMMENT ON COLUMN "BOARD_REPLY"."RCONTENT" IS '내용';
COMMENT ON COLUMN "BOARD_REPLY"."RDATE" IS '작성시간';
COMMENT ON COLUMN "BOARD_REPLY"."REP" IS '타겟댓글번호';
COMMENT ON COLUMN "BOARD_REPLY"."REPS" IS '댓글순서';
COMMENT ON COLUMN "BOARD_REPLY"."REPL" IS '댓글 깊이';
>>>>>>> Stashed changes
COMMENT ON COLUMN "BOARD_REPLY"."MID" IS '아이디';
