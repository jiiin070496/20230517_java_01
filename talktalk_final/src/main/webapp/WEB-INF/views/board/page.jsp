...
.page_next { background: url("images/page_next.jpg") center no-repeat; }
.page_last { background: url("images/page_last.jpg") center no-repeat; }
.page_prev { background: url("images/page_prev.jpg") center no-repeat; }
.page_first { background: url("images/page_first.jpg") center no-repeat; }
